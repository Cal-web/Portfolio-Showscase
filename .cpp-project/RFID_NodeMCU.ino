/*This code was created by Calvin Mhongwe, for a school project.. 
...
const char *ssid = "ARSENAL";  //ENTER YOUR WIFI SETTINGS
const char *password = "AUBAMEYANG";

//Web/Server address to read/write from 
const char *host = "192.168.137.17";   //IP address of server
...
void loop() {
 ...
 for (byte i = 0; i < mfrc522.uid.size; i++) {
  ...
  Link = "http://192.168.137.17/loginsystem/postdemo.php" + getData;
